load Data/Data_ts_ptc_IGD_rho_3.mat
data1 = data;
load Data/Data_ts_ptc_IGD_rho_6.mat
data2 = data;
load Data/Data_ts_ptc_IGD_rho_9.mat
data3 = data;
...
legend([p1, p2, p3] ,'$e_{p,y}$  ($\rho=0.3$)','$e_{p,y}$  ($\rho=0.6$)','$e_{p,y}$  ($\rho=0.9$)','Location','best', 'FontName', 'times new Roman','fontsize',fontsize,'interpreter','latex','NumColumns',1);
hold off;
